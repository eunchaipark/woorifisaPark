#https://stock-app-sample.streamlit.app/
...
if button_result:
    ...
    if ticker_symbol:  
        ...
        st.dataframe(df.tail(7),width=900)
        ...
        with col2:
            df.to_csv(excel_data)
            st.download_button("CSV 파일 다운로드", excel_data, file_name='stock_data.csv')
